...
public class FavRhymesMenuActivity extends AppMenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grid.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position,
                    long id) {
            	Context curContext = FavRhymesMenuActivity.this;
            	DownloaderStandard downloader = null;
            	
            	switch(position){
            		//with my res incompl
	            	case 0:
	            		downloader = new RepoDefaultReq(curContext).writeRespUserFav();
	            		break;
	            	//with my res compl
	            	case 1:
	            		downloader = new RepoDefaultReq(curContext).complRhymeNoAuthorFav();
	            		break;
            	}	
            	if(downloader != null)
            		downloader.execute();
