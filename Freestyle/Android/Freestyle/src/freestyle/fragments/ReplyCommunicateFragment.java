...
public class ReplyCommunicateFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View result = inflater.inflate(R.layout.fragment_reply_communicate_view, container, false);
        TextView communicate = (TextView) result.findViewById(R.id.view_reply_communicate_text);
